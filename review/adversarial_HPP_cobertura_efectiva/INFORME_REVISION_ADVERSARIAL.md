...
- **C18. Figuras.** Existen en el documento (los comentarios internos las discuten) pero son de calidad insuficiente. Entregarlas a resolución de publicación, orientación 4×1 por clúster, con peldaños de cascada explícitos, banda de IC95%, línea nacional de referencia y leyendas autoexplicativas. Mover la Tabla 4 (45×8) a anexo y dejar en el cuerpo un resumen por clúster. *(P7 + comentarios internos)*

---

## 5. Defectos P2 — menores, y P3 — clarificaciones/artefactos

**Menores (P2):** sobreafirmación de la biología de HP (C19); siglas/variables inconsistentes y contradicción nombre-vs-fórmula del IMR (C20); referencias citadas ausentes de la lista — Heise 2009, Chatignoux 2021, Navarrete 2018, Latorre 2024, Thiruvengadam 2024, Leslie 2019 (C21); ~27 errores de inglés/tipeo y abstract con oraciones rotas (C22); prevalencia HP histórica y corte etario 40+ apoyado en un resumen de congreso (C23); tablas con encabezados fantasma, Anexo 2 en español, separadores de miles (C24).

**Clarificación importante — artefactos de extracción (P3):** el manuscrito se leyó vía extracción de texto del Google Doc. Las ecuaciones en "sopa de entidades" (`&#25;...`), los `[image]` y los enlaces `zotero.org/google-docs/?...` **son casi con certeza artefactos de esa exportación, no defectos del documento real** (los comentarios internos confirman que las ecuaciones y figuras existen). **No los persigan como defectos.** Lo que sí sobrevive a cualquier exportación —y es real— son los errores de inglés, las siglas inconsistentes, las referencias faltantes y el Anexo 2 en español. Al exportar a Word/PDF para la sumisión, limpiar solo los residuos reales (comentarios y control de cambios).
...
- **¿Figuras ausentes o débiles?** P1/P7 las leyeron como "100% ausentes"; el editor las reclasifica como **existentes pero de calidad insuficiente** (evidencia: comentarios internos #4 y #12). Prevalece la lectura corregida.
